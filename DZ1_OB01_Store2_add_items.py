...
# Создание магазина
my_store = Store("Перспектива", "ул. Восстания, 80")

# Добавление товаров
my_store.add_item("Гвозди", 0.25)
my_store.add_item("Саморезы", 0.55)
my_store.add_item("Дюбеля", 0.75)
my_store.add_item("Вертикальный подвес", 0.90)
